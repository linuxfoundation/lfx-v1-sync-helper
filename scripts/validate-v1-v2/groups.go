...
type TableConfig struct {
	...
	MeetingIDAttribute         string   // when set, records are filtered to allowed meetings via allowedMeetingIDs
...
var allTables = []TableConfig{
	// ── Meetings ─────────────────────────────────────────────────────────────
	{
		...
		ProjectAttribute: "proj_id",
		IgnoreV2Fields: []string{"id", "updated_at", "title", "description", "artifact_visibility", "zoom_config", "project_uid", "committee_uid", "committees", "project_sfid", "early_join_time_minutes", "occurrences", "updated_occurrences[*].title", "updated_occurrences[*].description", "show_meeting_attendees"},
		IgnoreV1Fields: []string{"topic", "agenda", "early_join_time", "proj_id", "meeting_id", "passcode", "zoom_ai_enabled", "modified_at", "updated_by.id", "created_by.id", "require_ai_summary_approval", "updated_by_list[*].id", "updated_occurrences[*].topic", "updated_occurrences[*].agenda"},
	},
	{
	...
	},
	{
		...
		MeetingIDAttribute: "meeting_id",
		IgnoreV2Fields: []string{"uid", "updated_at", "committee_uid", "avatar_url", "org_name"},
		IgnoreV1Fields: []string{"profile_picture", "registrant_id", "org", "updated_by.id", "committee_id", "modified_at", "created_by.id"},
	},
	{
